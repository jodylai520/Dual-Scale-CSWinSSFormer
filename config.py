...
MSUNet_synapse_version4_cls9_v1 = {
    'save_path': '/home/lthpc/daniel/results/MS/MS_V9_2',
    ...
    'scheduler_args': {},
    'train_loader_args': {'batch_size': 17, 'shuffle': True, 'num_workers': 1, 'pin_memory': True, 'drop_last': True},
    'validate_loader_args': {'batch_size': 17, 'shuffle': True, 'num_workers': 1, 'pin_memory': True, 'drop_last': True},
    'eval_frequncy': 5,
    'flags': {
        'save_history': True
    }
